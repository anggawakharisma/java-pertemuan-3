...
//
    ...
    private static ShipperInterface getMappingShipper(String shipperName) {
        Map<String, ShipperInterface> mappingShipper = new HashMap<>();
        mappingShipper.put("JNE", new JNE());
        mappingShipper.put("Sicepat", new Sicepat());
        return mappingShipper.get(shipperName);
    }

    public static ShipperInterface getMappingShipperInterface(String shippername){
        Map<String, ShipperInterface> mappingShipper = new HashMap<>();
